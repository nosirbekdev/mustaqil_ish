<footer class="bg-blue-900 text-white py-8">
  <div class="container mx-auto max-w-6xl grid grid-cols-6 gap-6">
    ...
    <div>
      ...
      <p class="text-sm">Manzil: Toshkent shahri, Kichik Xalqa Yo'li, G-9a mavzesi, 21-a uy</p>
        <p class="text-sm">Telefon: +998 71 230-12-92</p>
        <p class="text-sm">E-pochta: gulnoz7410@mail.ru</p>
    </div>
    ...
    <!-- Bog'lanish -->
    <div>
      <h3 class="text-lg font-semibold mb-4 text-[#FFD960]">Biz bilan bog'lanish</h3>
      <ul class="space-y-2">
